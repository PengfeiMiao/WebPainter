...
import com.example.test.annotation.OverrideFor;
...
public final class AnnotationUtils {
    ...
    public static class OverrideDescriptor {
        ...
        private String getOverrideAttributeName(OverrideFor overrideFor, Method sourceAttribute) {
            ...
            boolean hasAttribute = !StringUtil.isBlank(attribute);
            boolean hasValue = !StringUtil.isBlank(value);
            ...
            return !StringUtil.isBlank(attribute) ? attribute : sourceAttribute.getName();
        }
    }
